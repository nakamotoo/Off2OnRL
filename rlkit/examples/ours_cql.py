...
from rlkit.torch.sac.ours_cql import (
    OursCQLTrainer,
)
...
def experiment(variant, args):
    ...
    """ Prepare networks """
    qf1 = ParallelMlp(
        obs_dim + action_dim, M, critic_num_hidden_layers, 1, args.ensemble_size
    ).to(ptu.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", default="antmaze-medium-diverse-v0", type=str)
